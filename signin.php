    ...
    <?php 
        ...
        if (isset($_POST['signin'])) {
            ...
            if ($user->emailNotExists()) {
                $bs->displayAlert("Invalid password Email", "danger");
                 //echo "<div class='alert alert-danger' role='alert'>Email does't exists</div>";
            } else {
                if ($user->verifyPassword()) {
                    //$bs->displayAlert("Email is not exists", "danger");
                    //echo "<div class='alert alert-success' role='alert'>Password matches</div>";
                } else {
                    $bs->displayAlert("Invalid Password", "danger");
